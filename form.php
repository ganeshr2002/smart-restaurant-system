...
<div id="formid">
       <div class = "formcontainer" style="font-size: 20px;padding:1%; margin: 5% 30% 10% 30%;" style="display:none;">
            <form action="addcustomer.php" method="post">
                    <h2 style="text-align:center;font-family:cursive;color:black;">USER LOGIN</h2>
                    <br>
